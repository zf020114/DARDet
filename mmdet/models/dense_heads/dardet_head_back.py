...
from mmdet.core import (bbox2distance, build_anchor_generator,distance2rbox,multiclass_nms_rotated_bbox,rotated_box_to_poly,poly_to_rotated_box,
    ...
    def _get_bboxes_single(self,
        ...
        if with_nms:
            ...
            det_bboxes,  det_labels = multiclass_nms_rotated_bbox(mlvl_rboxes,#mlvl_bboxes,
                                                        ...
                                                        cfg.score_thr, cfg.nms,
                                                        cfg.max_per_img)
            # det_bboxes,  det_labels = multiclass_nms_rotated_bbox(mlvl_rboxes,
